package ui.vtool {
	...
	public class CapturePanel extends VComponent {
		private const
			targetBt:VButton = VToolPanel.createTextButton('Цель', 90, onTarget),
			depthBt:VButton = VToolPanel.createTextButton('Дети', 90, onDepth, null, 'Orange'),
			grid:VGrid = new VGrid(1, 7, CaptureRenderer, 0, 16, 0, 4, VGrid.H_STRETCH | VGrid.FLOAT_INDEX)
			;
		private var
